...
@Component({
  selector: 'app-mapbfh',
  templateUrl: './mapbfh.component.html',
  styleUrls: ['./mapbfh.component.css']
})
export class MapbfhComponent implements OnInit, OnDestroy{
  ...
  initializeMap(): Promise<any> {
    ...
    const obraCulminadas = new FeatureLayer({
      url: 'https://dportalgis.vivienda.gob.pe/dhtserver/rest/services/DGPPVU/2_Seguimiento_Monitoreo/MapServer/0',
      title: 'Obras Culminadas por el Fenomeno del Niño Costero 2017'
    }); mapa.add(obraCulminadas);

    const cdc_cofopri = new FeatureLayer ({
      url: 'http://geoportal.cofopri.gob.pe/cofopri/rest/services/CDC/CDC_2023/FeatureServer/0'
    }); mapa.add(cdc_cofopri)
    //Cargado del mapa
